...
* Adds an export of `UpdatingElement` as `ReactiveElement` for forward-compatibility with with lit-element 3.0 [#1177](https://github.com/Polymer/lit-element/issues/1177).
