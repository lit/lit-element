...
export abstract class UpdatingElement extends HTMLElement {
  ...
  private _updatePromise =
      new Promise((res) => this._initializeUpdatingResolver = res);
  private _initializeUpdatingResolver: (() => void)|undefined;
  ...
  protected initializeUpdating() {
    if (this._initializeUpdatingResolver) {
      this._initializeUpdatingResolver();
      this._initializeUpdatingResolver = undefined;
    }
  }
