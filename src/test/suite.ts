...
(() => {
  ...
  // browser.
  var suiteChild = window.suiteChild;
  ...
  var fnNameDesc = Object.getOwnPropertyDescriptor(function() {}, 'name');
  var testBabel = fnNameDesc && fnNameDesc.configurable && Array.prototype.find;
